...
- To learn more about Swagger UI, please visit the https://swagger.io/tools/swagger-ui/[official website], or check this https://www.youtube.com/watch?v=GxAu8UjLfbM[video].
